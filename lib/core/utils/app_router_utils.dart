  ...
  routes: [
    GoRoute(path: '/SplashScreen', builder: (context, state) => Splashscreen()),
     GoRoute(path: '/ReportScreen', builder: (context, state) => ReportScreen()),
          GoRoute(path: '/DevicesScreen', builder: (context, state) => DevicesScreen()),
    GoRoute(path: '/HomeScreen', builder: (context, state) => HomeScreen()),
    GoRoute(path: '/DeviceSetupScreen', builder: (context, state) => DeviceSetupScreen()),
    GoRoute(path: '/WeightScreen', builder: (context, state) => WeightScreen()),
    GoRoute(path: '/InsulinScreen', builder: (context, state) => InsulinScreen()),
    GoRoute(path: '/NutritionScreen', builder: (context, state) => NutritionScreen()),
    GoRoute(path: '/ProfileScreen', builder: (context, state) => ProfileScreen()),
    GoRoute(path: '/SetupProfile', builder: (context, state) => SetupProfile()),
    GoRoute(path: '/GlucoseScreen', builder: (context, state) => GlucoseScreen()),
    GoRoute(path: '/SettingScreen', builder: (context, state) => SettingsScreen()),
    GoRoute(path: '/BolusWizard', builder: (context, state) => BolusWizard()),
    GoRoute(path: '/BasalWizard', builder: (context, state) => BasalWizard()),
    GoRoute(path: '/SmartBolusScreen', builder: (context, state) => SmartBolusScreen()),
    GoRoute(path: '/DevicesScreen', builder: (context, state) => DevicesScreen()),
     GoRoute(path: '/PaymentScreen', builder: (context, state) => BuySubscription()),
  ],
);
